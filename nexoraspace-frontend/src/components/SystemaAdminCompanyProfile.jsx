...
export default function SystemAdminCompanyProfile() {
  ...
  const handleDelete = () => {
    const confirmDelete = window.confirm(
      `Are you sure you want to delete the company "${formData.companyName}"?`
    );
    if (confirmDelete) {
      console.log("Company Deleted:", formData.companyName);
      // 🔹 Here you can call your backend API to delete the company
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 text-gray-100">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-4 sm:p-6 mb-8 sm:mb-10 
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <span
              className={`mt-1 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-semibold text-center w-fit ${
...
const Section = ({ title, children }) => (
  <div>
    <h2 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-yellow-400">
      {title}
    </h2>
    {children}
  </div>
